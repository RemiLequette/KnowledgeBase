...
// ---------------------------------------------------------------------------
// Minimal config for tests — uses real type handlers, fixture folder as root
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// TypeRegistry — copied from forge.js, augmented with exports
// ---------------------------------------------------------------------------

export class TypeRegistry {
  constructor() {
    /** @type {Map<string, { handler: object, described: boolean }>} */
    this.handlers = new Map();
    /** @type {string[]} type names sorted by specificity (descending length) */
    this.discoveryOrder = [];
    /** @type {Set<string>} Brand registry — FALs issued by Forge this session */
...
// ---------------------------------------------------------------------------
// RootRegistry — copied from forge.js
// ---------------------------------------------------------------------------
