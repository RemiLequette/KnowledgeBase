...
- [ ] md-doc: add `delete` command to remove a section from a document
- [ ] md-doc: add position control for section insertion (beginning, after a named section, before a named section)
- [ ] md-doc: `update`, `read`, `dump` must return `ERROR:NOT_CONFORMANT` when the target file fails `check`
